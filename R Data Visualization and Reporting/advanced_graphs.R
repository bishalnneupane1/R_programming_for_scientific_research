...
#  Load data:
df <- read.csv('Erbil_Rain_Annual.csv')
View(df)
...
###
df <- read.csv('Climatic_Variables_and_Lag7R0_Australia.csv')
...
# Animated boxplot
# Load data:
dt <- read.csv('Climatic_Variables_and_Lag7R0_Australia.csv')
